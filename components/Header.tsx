...
const Header = () => {
  return (
    <header className="w-full gap-7 flex items-center justify-center flex-col text-center  py-8 z-40">
      ...
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold">Create & Share</h1>
      <h2 className="text-2xl md:text-2xl lg:text-4xl  font-semibold text-slate-800">Your Code easily</h2>
    </header>
  );
};
